...
--
-- Table structure for table `se_comment`
--

DROP TABLE IF EXISTS `se_comment`;
...
--
-- Dumping data for table `se_comment`
--

LOCK TABLES `se_comment` WRITE;
/*!40000 ALTER TABLE `se_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `se_comment` ENABLE KEYS */;
UNLOCK TABLES;
